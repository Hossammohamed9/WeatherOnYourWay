...
class LocationClass(val context: Context) {
    ...
    private fun enableLocationSitting(context: Context, activity: Activity) {
        ...
        if (!MainActivity.readFromDatabase) {
            ...
            alertDialogBuilder.setTitle(context.getString(R.string.didnt_enable_loc))
            alertDialogBuilder.setMessage(context.getString(R.string.load_details))
            alertDialogBuilder.setPositiveButton(context.getString(R.string.enable)) { dialog, _ ->
